    ...
    function loadGeom(error, TotalPoC, NonSatelliteCities, SatelliteCities){
        ...
        var map = L.map('map', {zoomControl:false, attributionControl: false } ).setView([39.364, 35.673], 7);
		...
		legend.onAdd = function (map) {
			...
			var div = L.DomUtil.create('div', 'info legend'),
				labels = ['<strong> LEGEND</strong>', "<img src='images/legend/asam.png' height=20>ASAM Offices", "<img src='images/legend/hrdf.png' height=20>HRDF (IKGV)", "<img src='images/legend/ibc.png' height=20>Legal Aid", "<img src='images/legend/stl.png' height=20>TIHV", "<img src='images/legend/TRC.png' height=20>Kader/ KDD"],
				from, to;
